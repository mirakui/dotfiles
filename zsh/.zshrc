...
alias claude-dev='claude --append-system-prompt "read @~/.claude/contexts/dev.md" --allow-dangerously-skip-permissions'
alias claude-review='claude --append-system-prompt "read @~/.claude/contexts/review.md " --allow-dangerously-skip-permissions'
alias claude-research='claude --append-system-prompt "read @~/.claude/contexts/research.md" --allow-dangerously-skip-permissions'
